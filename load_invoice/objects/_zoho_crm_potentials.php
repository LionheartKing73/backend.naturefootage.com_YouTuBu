...
echo get_potential_id_from_zoho("SFR5865f57");

	function get_potential_id_from_zoho($sfrcode)
	{
	...
	// Check for errors and display the error message
		...
		else
		{
			...
			if($error == "")
			{
				foreach($array_potential as $potential_line)
				{
						return $potential_line["POTENTIALID"];
				}
			}
			else
			{
