...
if($_SERVER['environment'] == 'staging') {
    ...
    $dsn= 'mysql:host=master-aurora-new-cluster.cluster-ciayufran1ab.us-east-1.rds.amazonaws.com;dbname=fsmaster-nfstage;charset=utf8';
    $userB='fsmaster';
    $passB='FSdbm6512';

} elseif($_SERVER['environment'] == 'production') {

    $dsn= 'mysql:host=master-aurora-new-cluster.cluster-ciayufran1ab.us-east-1.rds.amazonaws.com;dbname=fsmaster-production;charset=utf8';
    $userB='fsmaster';
    $passB='FSdbm6512';
}
...
$config = array(
    ...
    */
    ...
    'example-sql' => array(
        ...
        'username' => $userB,
        'password' => $passB,
        'query' => 'SELECT email, login given_name, id, lname surname FROM lib_users WHERE login = :username AND password = :password;'
    ),
