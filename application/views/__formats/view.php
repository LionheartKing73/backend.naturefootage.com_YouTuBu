...
<div class="btn-group toolbar-item">
    ...
    <a class="btn" href="<?=$lang?>/formats/<?=$type?>/edit"><?=$this->lang->line('add');?></a>
    <? endif; ?>
    <? if ($this->permissions['formats-delete']): ?>
    <a class="btn" href="javascript: if (check_selected(document.formats, 'id[]')) change_action(document.formats,'<?=$lang?>/formats/<?=$type?>/delete');"><?=$this->lang->line('delete');?></a>
    <? endif; ?>
</div>
    ...
    <table class="table table-striped">
        ...
        if($formats) {
            ...
            foreach($formats as $format) {?>
                <tr>
                    <td><input type="checkbox" name="id[]" value="<?=$format['id']?>"></td>
                    <td><?=$format['title']?></td>
                    <td><?=$format['code']?></td>
        ...
        <? }} else {?>
            <tr><td colspan="3" align="center"><?=$this->lang->line('empty_list');?></td></tr>
        <?}?>
