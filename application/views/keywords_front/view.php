<form name="filter" action="<?php echo $lang; ?>/keywords_front/view" id="form_filter" method="POST">
...
<div class="btn-group toolbar-item">
    <?php if ($this->permissions['keywords-delete']) { ?>
        <span class="btn ajaxify" id="add" data-action="en/keywords_front/add">Add</span>
        <a class="btn" onclick="javascript: if (check_selected(document.keywords, 'id[]'))
                        change_action(document.keywords, '<?= $lang ?>/keywords_front/delete');
...
<!--        <span>Collection:</span><input type="text" name="collection" class="to" style="width: 260px;" value=""><br>-->
        ...
        <select name="section" style="width: 260px;">
            <option selected="">Select Section List</option>
            <?php
