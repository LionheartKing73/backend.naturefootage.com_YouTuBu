...
<script type="text/javascript">
    $("#uploader").plupload({
        ...
        url : "/<?=$lang?>/upload/index/0/res/<?=$submission_code?>/<?=$user_id?>",
        chunk_size : "512kb",
        unique_names : false,
        filters : [
            {title : "Video files", extensions : "mov,mp4,avi,r3d"}
...
<?php if($is_provider && $fc_server) { ?>
<p>
<script type="text/javascript" src="/data/uftp/UploadApplet/deployJava.js"></script>
<script type="text/javascript">
    ...
    var parameters = {
        server			     :"<?php echo $fc_server; ?>",
        port			     :"<?php echo $fc_port; ?>",
        user			     :"<?php echo $provider_login; ?>",
        pass			     :"<?php echo $provider_password; ?>",
    ...
    var attributes = {
        name: "FileCatalyst",
        codebase: "/data/uftp/UploadApplet",
...
<p><a href="http://www.java.com" target="new" id="getJava">If the applet does not load,&nbsp; please click here</a></p>
<?php } ?>