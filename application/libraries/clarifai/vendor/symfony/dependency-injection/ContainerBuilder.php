...
require_once(APPPATH . '/libraries/clarifai/vendor/symfony/dependency-injection/Container.php');
require_once(APPPATH . '/libraries/clarifai/vendor/symfony/dependency-injection/TaggedContainerInterface.php');
require_once(APPPATH . '/libraries/clarifai/vendor/symfony/dependency-injection/Definition.php');
require_once (APPPATH . '/libraries/clarifai/src/Token/Storage/Filesystem.php');
require_once (APPPATH . '/libraries/clarifai/src/Request/Endpoint.php');
require_once (APPPATH . '/libraries/clarifai/src/Request/EndpointAuthenticate.php');
require_once (APPPATH . '/libraries/clarifai/src/Responses/ResponseFactory.php');
require_once (APPPATH . '/libraries/clarifai/src/Endpoints/Authenticate.php');
require_once (APPPATH . '/libraries/clarifai/src/Endpoints/Tag.php');
require_once (APPPATH . '/libraries/clarifai/src/Endpoints/Info.php');
require_once (APPPATH . '/libraries/clarifai/src/Endpoints/Language.php');
