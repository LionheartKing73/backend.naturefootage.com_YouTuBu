...
require_once (APPPATH . '/libraries/clarifai/vendor/php-curl-class/php-curl-class/src/Curl/CaseInsensitiveArray.php');
require_once (APPPATH . '/libraries/clarifai/vendor/php-curl-class/php-curl-class/src/Curl/ArrayUtil.php');
